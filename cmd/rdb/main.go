// cloned from
// https://github.com/HDT3213/rdb/blob/b5e024cd842d14b69fed753024ed443949ac5221/cmd.go#L1
package main
...
Options:
  -c command, including: json/memory/aof/bigkey/prefix/flamegraph/jsonl
  -e encoding, including: none(default)/gob
  -o output file path
...
7. (added) convert to jsonl file 
  rdb -c jsonl -o dump.jsonl -e gob dump.rdb
`
...
func main() {
	...
	flagSet.StringVar(&encoding, "e", "none", "encoding for jsonl: none(default)/gob")
	...
	case "flamegraph":
		...
		<-make(chan struct{})
	// added for jsonl. ignore options
	case "jsonl":
		err = ToJSONLine(src, output, encoding)
	default:
